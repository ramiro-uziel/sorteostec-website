...
<header
  class={"sticky z-10 top-0 duration-200 px-8 xl:px-80 lg:px-32 md:px-8 flex items-center justify-between border border-solid " +
    (y > 0
      ? "py-4 bg-st-blue border-blue-800 bg-opacity-90 "
...
<nav
  class="sticky bg-st-blue-light text-slate-950 items-center justify-center hidden lg:flex"
>
...
<nav class="sticky bg-st-blue-light text-slate-950 px-5 lg:hidden">
